export const v3 = {
  ...
  "capabilities": [
    "Domain-specific workbench: Booking Flow Decision Matrix",
    "Operational table: Booking requirements",
  ...
  "releaseChecklist": [
    ...
    "Scheduler Fit reaches production threshold",
    "Booking Friction is documented with evidence",
    "QA Confidence has no unresolved blocker",
    "Vendor decision matrix verified",
    "Reminder copy pack verified",
    "QA script verified"
  ],
  "operations": [
